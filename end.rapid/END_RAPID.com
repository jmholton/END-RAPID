...
#        updated for Phenix 2.x compatibility (ddr block removal)        -James Holton 5-31-26
#
#
...
# also strip parameter blocks unrecognized by Phenix 2.x (e.g. ddr)
cat $eff_file |\
...
awk '{tag[brace+0]=$1}\
   ...
   tag[0]=="data_manager" && tag[1]=="model"{next}\
